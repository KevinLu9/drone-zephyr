...
class UARTToPiZero():
    def __init__(self, uart, orientation_lock, drone_orientation, motor_lock, motors, adc_voltage_pin):
        self.uart = uart
        ...
        self.SEND_DATA_FREQUENCY = 1
        self.RECV_DATA_FREQUENCY = 10
    ...
    async def uart_send(self):
        while True:
            try:
                self.battery_voltage = self.voltage_adc.read_u16() / 65535 * 18.3, # read value, 0-65535 across voltage range 0.0v - 3.3v
